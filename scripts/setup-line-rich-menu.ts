    ...
    await page.setContent(`
      <style>
        * { box-sizing: border-box; }
        ...
        section { display: grid; place-content: center; width: 50%; text-align: center; }
        ...
        h1 { margin: 36px 0 10px; font-size: 94px; }
        p { margin: 0; font-size: 42px; opacity: .8; }
      </style>
      <main>
        <section><div class="icon">📄</div><h1>ดูบิล</h1><p>ยอดชำระและ QR PromptPay</p></section>
